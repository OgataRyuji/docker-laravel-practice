...
CREATE TABLE `items` (
  ...
  `item_explain` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL,
  `user_id` bigint unsigned NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000000_create_users_table',1),(2,'2014_10_12_100000_create_password_resets_table',1),(3,'2019_08_19_000000_create_failed_jobs_table',1),(4,'2019_12_14_000001_create_personal_access_tokens_table',1),(5,'2022_03_22_074631_create_items_table',1),(6,'2022_03_22_074724_create_pre_users_table',1),(7,'2022_03_22_074754_create_comments_table',1);
...
CREATE TABLE `pre_users` (
  ...
  `created_at` timestamp NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pre_users_email_unique` (`email`)
...
-- Dump completed on 2022-04-11 17:43:25
